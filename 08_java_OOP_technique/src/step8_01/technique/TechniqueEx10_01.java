...
interface BB {
	...
	// void test5() {}
	// 일반 메써드 (메써드 앞에 default 키워드를 붙인다.)
	default void test5() {
		System.out.println("default 메쏘드!");
	}
	
	// 정적 메써드 ( 메써드 앞에 static 키워드를 붙인다.)
	static void test6() {
...
// implements 키워드를 사용하여 인터페이스를 구현한다.("상속"은 아님)
